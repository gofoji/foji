...
const FojiSlashOpenapiSlashAuthDotGoDotTpl = `{{ .NotNeededIfNoAuth -}}
...
const FojiSlashOpenapiSlashStubDotYamlDotTpl = `openapi: "3.0.0"
info:
...
processes:
  ...
  openAPI:
    ...
    resources: [api]
    OpenAPIFile:
      'test/http/auth_gen.go': foji/openapi/auth.go.tpl

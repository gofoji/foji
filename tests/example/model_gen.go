...
// GetRawBodyVehicle
// Op: getRawBody Param: vehicle
type GetRawBodyVehicle int8

const (
	UnknownGetRawBodyVehicle GetRawBodyVehicle = iota
	GetRawBodyVehicleCar
	GetRawBodyVehicleTruck
...
func NewGetRawBodyVehicle(name string) GetRawBodyVehicle {
	switch name {
	case "car":
		return GetRawBodyVehicleCar
	case "truck":
		return GetRawBodyVehicleTruck
	case "bike":
		return GetRawBodyVehicleBike
	}

	return GetRawBodyVehicle(0)
}

var GetRawBodyVehicleString = map[GetRawBodyVehicle]string{
	GetRawBodyVehicleCar:   "car",
	GetRawBodyVehicleTruck: "truck",
	GetRawBodyVehicleBike:  "bike",
}

func (e GetRawBodyVehicle) String() string {
	return GetRawBodyVehicleString[e]
}

func (e *GetRawBodyVehicle) UnmarshalJSON(input []byte) (err error) {
	var i int8

	err = json.Unmarshal(input, &i)
	if err == nil {
		*e = GetRawBodyVehicle(i)
		return nil
	}
	...
	*e = NewGetRawBodyVehicle(s)

	return nil
}

func (e GetRawBodyVehicle) MarshalJSON() ([]byte, error) {
	return json.Marshal(e.String())
}

func (e GetRawBodyVehicle) Value() (driver.Value, error) {
	return json.Marshal(e.String())
}

func (e *GetRawBodyVehicle) Scan(src interface{}) error {
	s, ok := src.(string)
	if !ok {
		return fmt.Errorf("GetRawBodyVehicle.scan: scanned a %T, not []byte", src) //nolint
	}

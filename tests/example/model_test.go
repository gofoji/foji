	...
	testCases := []struct {
	...
	}{
		{
			...
			Expected: AddInlinedBodyRequest{
				...
				F08Null:  new(AddInlinedBodyRequestF08NullValueB),
				F10:      []string{"a"},
				F13:      "someValue",
				F13Null:  new("someValue2"),
			},
		},
		{
			Name: "maximal",
...
"f10": ["a", "b"], "f11": [4, 5], "f12": ["fall", "spring"], "f13": "f13Test", "f13Null": "f13NullTest"}`,
			Expected: AddInlinedBodyRequest{
				...
				F01BNull: new(true),
				F02:      2,
				F02Null:  new(int32(21)),
				F03:      3,
				F03Null:  new(int32(31)),
				F04:      4,
				F04Null:  new(int64(41)),
				F05:      time.Date(2025, 1, 1, 12, 0, 0, 0, time.UTC),
				F05Null:  new(time.Date(2025, 2, 1, 12, 0, 0, 0, time.UTC)),
				F06:      uuid.MustParse("b043c679-354a-4170-a061-dfe2271b3c77"),
				F06Null:  new(uuid.MustParse("f4e1d34e-231a-4e4d-a904-318e8edd5a29")),
				F07:      "f7Test",
				F07Null:  new("f7NullTest"),
				F08:      AddInlinedBodyRequestF08ValueB,
				F08Null:  new(AddInlinedBodyRequestF08NullValueC),
				F09:      SeasonSummer,
				F09Null:  new(SeasonNullableFall),
				F10:      []string{"a", "b"},
				F11:      []int32{4, 5},
				F12:      []Season{SeasonFall, SeasonSpring},
				F13:      "f13Test",
				F13Null:  new("f13NullTest"),
			},
		},
	}
	...
	testCases := []struct {
	...
	}{
		{
			...
			Expected: AddFormRequest{
				...
				F08Null:  new(AddFormRequestF08NullValueB),
				F10:      []string{"a", "b"},
				F13:      "someValue",
				F13Null:  new("someValue2"),
			},
		},
		{
			...
			Expected: AddFormRequest{
				...
				F08Null:  new(AddFormRequestF08NullValueC),
				F09:      SeasonSummer,
				F09Null:  new(SeasonNullableFall),
				F10:      []string{"a", "b"},
				F11:      []int32{4, 5},
